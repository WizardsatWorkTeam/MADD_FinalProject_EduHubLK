...
class QuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants.getQue()
    ...
    private fun setQuestion() {
        ...
        text_progress.text = "$mCurrentPosition" + "/" + progress_bar.getMax()

        tv_question.text = question.question
        option_one.text = question.option1
        option_two.text = question.option2
        option_three.text = question.option3
        option_four.text = question.option4
    }
